...
53:50에 해당되는 비트는 VMCS 및 참조되는 구조체에 대한 메모리 타입(Uncacheable, WriteBack 등)을 반환합니다.
![](/assets/posts/2025-04-28-EPT/11.png)

### IA32_FEATURE_CONTROL
IA32_FEATURE_CONTROL(3A)를 통해 제어어되는 정보는 다음과 같습니다.  
비트 0
![](/assets/posts/2025-04-28-EPT/14.png)

### IA32_VMX_EPT_VPID_CAP
IA32_VMX_EPT_VPID_CAP(48CH)를 통해 반환되는 정보는 다음과 같습니다.  
